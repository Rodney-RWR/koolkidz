...
<button onclick="window.location.href='/users'" style="width:auto;">User List</button>
<button onclick="window.location.href='https://www.koolkidzmc.com/'" style="width:auto;">Main Website</button>
